...
const THEME_OPTIONS: I_DropdownOption[] = [
    { id: 'arcade',    label: 'Arcade',    value: 'arcade',    description: 'Antique gold & sage — SNES RPG warmth' },
    { id: 'phosphor',  label: 'Phosphor',  value: 'phosphor',  description: 'Forest green & leaf — Zelda / DKC palette' },
    { id: 'sovereign', label: 'Sovereign', value: 'sovereign', description: 'Battle crimson & pale gold — FFVI authority' },
    { id: 'void',      label: 'Void',      value: 'void',      description: 'Cobalt steel & violet — N64 space odyssey' },
    { id: 'dusk',      label: 'Dusk',      value: 'dusk',      description: 'Magic purple & rose flash — Chrono Trigger' },
    { id: 'parchment', label: 'Parchment', value: 'parchment', description: 'Aged paper & warm brown — SNES game manual' },
    { id: 'snes',      label: 'SNES',      value: 'snes',      description: 'Authentic 16-bit — pixel font, hard shadows, Press Start 2P' },
    { id: 'n64',       label: 'N64',       value: 'n64',       description: 'Console charcoal · logo gradient · A/B/C/Start button palette' },
]
